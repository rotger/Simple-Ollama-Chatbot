...
1. If you want to set specific model on page load write it in URL. For example '''http://127.0.0.1/ollama.html?model=qwen3:14b'''
...
1. Если вы хотите поставить определённую модель во время загрузки страницы, укажите её в URL. Для примера '''http://127.0.0.1/ollama.html?model=qwen3:14b'''
